        ...
        return (
            <Form>
                <Item.Group divided>
                    <Item>
                        <Item.Content>
                            <Item.Header>Internal SCEP Service</Item.Header>
                            <Item.Description>
                                <Form.Field>
                                    <Radio
                                        label='Internal SCEP'
                    ...
                    <Item>
                        <Item.Content>
                            <Item.Header>Internal CA</Item.Header>
                            <Item.Description>
                                <Form.Field>
                                    <Radio
                                        label='Internal CA'
                    ...
                    <Item>
                        <Item.Content>
                            <Item.Header>External SCEP Service</Item.Header>
                            <Item.Description>
                                <Form.Field>
                                    <Radio
                                        label='External SCEP'
